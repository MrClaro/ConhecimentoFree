...
| -------------------------------------------------------------------------------------------------- | ------------------------ | ------ | -------- |
| [**Front-end Challenges**](https://github.com/felipefialho/frontend-challenges)                    | Repositório              | Inglês | ✔️ Sim   |
| [**Backend Challenges**](https://github.com/CollabCodeTech/backend-challenges)                     | Repositório              | Inglês | ✔️ Sim   |
...
| Nome                                                                                               | Tipo (Curso, Livro, etc) | Idioma | Gratuito |
| -------------------------------------------------------------------------------------------------- | ------------------------ | ------ | -------- |
| [**Try Public APIs for free**](https://github.com/public-apis/public-apis)                         | Repositório              | Inglês | ✔️ Sim   |
...
| Nome                                                                                               | Tipo (Curso, Livro, etc) | Idioma    | Gratuito |
| -------------------------------------------------------------------------------------------------- | ------------------------ | --------- | -------- |
| [**Padrões de commits**](https://github.com/iuricode/padroes-de-commits)                           | Repositório              | Português | ✔️ Sim   |
...
| Nome                                                                                               | Tipo (Curso, Livro, etc) | Idioma | Gratuito |
| -------------------------------------------------------------------------------------------------- | ------------------------ | ------ | -------- |
| [**README-Model**](https://github.com/shyoutarou/README-Model)                                     | Repositório              | Inglês | ✔️ Sim   |
| [**Readme-Templates**](https://github.com/Fernanda-Kipper/Readme-Templates)                        | Repositório              | Inglês | ✔️ Sim   |
